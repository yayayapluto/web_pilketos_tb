                    ...
                    <tbody>
                        @foreach($candidates as $candidate)
                            <tr>
                                ...
                                <td><a href="{{ $candidate->external_link }}" target="_blank">{{ $candidate->external_link }}</a></td>
                                <td>
                                    <div class="d-flex flex-column">
                                        <a href="{{ route('candidates.show', $candidate->candidate_id) }}" class="btn btn-info btn-sm mb-1">View</a>
                                        <a href="{{ route('candidates.edit', $candidate->candidate_id) }}" class="btn btn-warning btn-sm mb-1">Edit</a>
